...
def get_in_game_date(irl_day_number):
    ...
    match (irl_day_in_year-1) % 14:
        ...
        case 1: 
            return f"7 - 12 {months[month_index]}"
        case 2: 
            return f"13 - 18 {months[month_index]}"
        case 3: 
            return f"19 - 24 {months[month_index]}"
        case 4: 
            return f"25 {months[month_index]} - 3 {months[month_index+1]}"
        case 5: 
            return f"4 - 9 {months[month_index]}"
        case 6: 
            return f"10 - 15 {months[month_index]}"
        case 7:
            return f"16 - 21 {months[month_index]}"
        case 8:
            return f"22 - 27 {months[month_index]}"
        case 9:
